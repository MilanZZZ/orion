...
const FooterButton = [
  images.facebook, images.twitter, images.linkedin
]
...
<div className="footer-logo"><img className={`image`}
    ...
    <div className="button-container">
       ...
       <button className='footer-button'><img className='image image-footer' src={image}/></button>
       )}
       </div>
       </div>
...
<div className="resources-column">
  ...
  {['Our Agents','Member Stories', 'Video', 'Free Trial'].map((value)=>
...
<div className="resources-column">
  ...
  {['Partnerships','Terms of use', 'Privacy', 'Sitemap'].map((value)=>
  <a className="values">{value}</a>
  )}
</div>
...
<div className="resources-column add-dis">
  ...
  <EmailForm />
      ...
      <div className="copyright">Copyright @MilanWebDev  All rights reserved.</div>
