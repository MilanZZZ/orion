...
const Story = () => {
  return (
   <Page idProp={'Resources'} text={Text.story} textProp='story-text' layout='layout'
    topTextProp='story-top' buttonStyleProp='story-button'
    titleProp='story-title'
   imgContainerStyle='image-story' imgStyle='image' line={<Line />} numbers={<CountIt />} subtitleProp='story-subtitle'/>
  )
}
